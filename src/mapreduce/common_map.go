...
func doMap(
	...
	// Read input file, extract content
	dat_, err := ioutil.ReadFile(inFile)
	CheckErr(err)
	dat := string(dat_)

	// Apply MapF
	result := mapF(inFile, dat)

	// Serialize []KeyValue result to nReduce Json format file
